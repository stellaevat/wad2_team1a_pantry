...
Scatter over the basil leaves to serve.""", "ingredients" : {"Baby Potato":["2kg",True], "Olive Oil":["2 tbsp",False], "Red Onion":["1",False], "Red Pepper":["2",True], "Garlic":["3 cloves",False]}, "category" : ["Vegan", "Healthy", "Vegetarian"], "prep_time" : 15, "cook_time" : 60, "servings" : 4,
...
Heat the pan over a moderate heat, then wipe it with oiled kitchen paper.""", "ingredients" : {"Flour":["100g",False], "Egg":["2",True], "Milk":["300ml",False], "Sunflower Oil":["1 tbsp",False], "Salt":["a pinch",False]}, "category" : ["Vegetarian", "Under 30'","Desserts", "Easy Meals"], "prep_time" : 10, "cook_time" : 30, "servings" : 4,
...
About 10 mins before your parcels are ready, steam or boil the greens until tender. Toss in the oil and season. Serve alongside your chicken parcels with lemon wedges for squeezing over.""", "ingredients" : {"Chicken":["2 Breasts of",False], "Olive Oil":["1 tbsp",False], "Green Bean":["200g",True], "Garlic":["150g",False], "Puff Pastry":["320g",False], "Lemon" : ["1/2 of a",False]}, "category" : ["Mains", "Easy Meals", "Under 30'"], "prep_time" : 10, "cook_time" : 20, "servings" : 2,
...
When the timer goes off, drain and rinse the pasta in cool water to stop the cooking process.""", "ingredients" : {"Pasta":["500g",False], "Water":["1 Litre",False]}, "category" : ["Mains", "Easy Meals", "Under 30'", "Vegan"], "prep_time" : 2, "cook_time" : 10, "servings" : 1,
         "difficulty" : "easy", "pub_date" : datetime.date(2022,3,14), "stars" : 500, "filename" : "pasta.jpg"},
...
Using a spatula, fold the omelet in half. Cook for another 30 seconds, then slide the omelet to a plate. Serve immediately.""", "ingredients" : {"Egg":["2",True], "Cream":["1 tbsp",False], "Butter" : ["1/2 tbsp", False]}, "category" : ["Mains", "Easy Meals", "Under 30'", "Breakfast"], "prep_time" : 5, "cook_time" : 5, "servings" : 1,
         "difficulty" : "medium", "pub_date" : datetime.date(2022,3,14), "stars" : 22, "filename" : "omelet.jpg"},
        ...
        """Combine the chicken, arugula, cranberries, avocado, goat cheese, walnuts, vinaigrette, salt, and pepper in a large bowl, using your hands or 2 forks to fully incorporate the dressing.""", "ingredients" : {"Chicken":["12 Oz",False], "Arugula":["12 Cups",False], "Cranberry" : ["1/4 cup", True], "Avocado":["1",False], "Goat Cheese":["1/4",False], "Walnut":["1/4 Cup",True], "Honey Mustard Vinaigrette":["1/4 Cup",False]}, "category" : ["Mains", "Easy Meals", "Vegan", "Vegetarian", "Lunch"], "prep_time" : 5, "cook_time" : 0, "servings" : 4,
         "difficulty" : "easy", "pub_date" : datetime.date(2022,2,14), "stars" : 50, "filename" : "grilled-chicken-and-avocado-salad.jpg"},
