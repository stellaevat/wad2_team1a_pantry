...
@register.inclusion_tag('django_social_share/post_to_twitter.html', takes_context=True)
...
@register.inclusion_tag('django_social_share/post_to_facebook.html', takes_context=True)
...
@register.inclusion_tag('django_social_share/post_to_gplus.html', takes_context=True)
...
@register.inclusion_tag('django_social_share/send_email.html', takes_context=True)
...
@register.inclusion_tag('django_social_share/post_to_linkedin.html', takes_context=True)
...
@register.inclusion_tag('django_social_share/post_to_reddit.html', takes_context=True)
...
@register.inclusion_tag('django_social_share/post_to_telegram.html', takes_context=True)
...
@register.inclusion_tag('django_social_share/post_to_whatsapp.html', takes_context=True)
...
@register.inclusion_tag('django_social_share/save_to_pinterest.html', takes_context=True)
...
@register.inclusion_tag('django_social_share/pinterest_script.html', takes_context=False)
